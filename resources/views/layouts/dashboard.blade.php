                ...
                <div aria-labelle/dby="dropdownMenu1" class="dropdown-menu dropdown-menu-right dm-medium fs-12 animated fadeInDown">
                    ...
                    <ul data-mcs-theme="minimal-dark" class="media-list mCustomScrollbar">
                        @foreach($notifs as $notif)
                            ...
                            <?php $avatar = !empty($profile->companyLogoUrl) ? func::img_url($profile->companyLogoUrl, 50, 50) : func::img_url('placeholder.png', 50, 50); ?>
                            <li class="media">
                                <a href="/dashboard/mailbox?id={{ $notif->id }}">
                                    <div class="media-left avatar"><img src="{{ $avatar }}" alt="" class="media-object img-circle"> </div>
                ...
                @if (Auth::user())
                    <a id="dropdownMenu2" href="profile.html#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle header-icon lh-1 pt-15 pb-15">
                        <div class="media mt-0">
                            <div class="media-left avatar"><img src="{{ !empty(Auth::user()->companyLogoUrl) ? func::img_url(Auth::user()->companyLogoUrl, 50, 50) : func::img_url('placeholder.png', 50, 50) }}" alt="" class="media-object img-circle"> </div>
