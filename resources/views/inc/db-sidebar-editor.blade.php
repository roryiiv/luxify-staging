...
<aside data-mcs-theme="minimal-dark" style="background-image: url('/db/images/backgrounds/diamond.jpg')" class="main-sidebar mCustomScrollbar">
    ...
    <ul class="list-unstyled navigation mb-0">
        ...
        <li class="panel"><a href="/panel/users"><i class="ti-user"></i><span class="sidebar-title">User list</span></a></li>

        <li class="panel"><a href="/panel/products"><i class="ti-shopping-cart"></i><span class="sidebar-title">Product list</span></a></li>
