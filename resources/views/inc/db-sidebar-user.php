...
<aside data-mcs-theme="minimal-dark" style="background-image: url('../images/backgrounds/diamond.jpg')" class="main-sidebar mCustomScrollbar">
    <div class="user">
        ...
        <p class="mb-0 text-muted">Luxify User</p>
    </div>
    <ul class="list-unstyled navigation mb-0">
        <li class="sidebar-category pt-0">Main</li>
        <li><a href="/dashboard/profile" class="bubble active"><i class="ti-user"></i><span class="sidebar-title">My Profile</span></a></li>
        ...
        <li><a href="/dashboard/wishlist" class="bubble"><i class="ti-heart"></i><span class="sidebar-title">Wishlist</span></a></li>
        ...
        <li><a href="" data-toggle="modal" data-target=".bs-example-modal" class="bubble"><i class="ti-support"></i><span class="sidebar-title">Support</span></a></li>
    </ul>
</aside>
