...
@section('title')
    <title>{{ func::genTitle(trans('metaheader.meta_search_title'), false)}}</title>
@endsection
@section('meta-data')
    <meta name="title" content"@lang('metaheader.meta_search_title')">
    <meta name="keywords" content="@lang('metaheader.meta_search_keywords')">
    <meta name="description" content="@lang('metaheader.meta_search_description')">
@endsection
@section('style')
